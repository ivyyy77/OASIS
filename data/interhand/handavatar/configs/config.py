...
def make_cfg():
    ...
    # cfg.merge_from_file('./tools_utils/model/handavatar/configs/interhand/test_cap0.yaml')
    cfg.merge_from_file('./tools_utils/model/handavatar/configs/interhand/test_cap1.yaml')
...
parser.add_argument("--cfg", default='./data/interhand/handavatar/configs/interhand/test_cap0.yaml', type=str) # 'ROM03_RT_No_Occlusion.yaml'
