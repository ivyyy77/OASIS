...
def _is_better(curr_metrics, best_metrics):
    ...
    best_lpips = best_metrics.get("lpips", float("inf"))
    best_psnr = best_metrics.get("psnr", 0.0)

    improved_lpips = curr_lpips < best_lpips
    improved_psnr = curr_psnr > best_psnr

    return improved_lpips or improved_psnr
