...
def main(argv):
    ...
    for iteration in pbar:
        ...
        runner.run_interhand(batch=batches, scaler=scaler, iteration=iteration, writer=writer, pbar=pbar, total_iters=FLAGS.iter)    # hand
        ...
        if iteration % 200 == 0 or iteration == FLAGS.iter:
